...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.UserLevelGroupDayLimit(), middleware.Distribute())
	{
	...
	relayV1Router.Use(middleware.UserLevelGroupDayLimit())
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.UserLevelGroupDayLimit(), middleware.Distribute())
	{
	...
	relayGeminiRouter.Use(middleware.UserLevelGroupDayLimit())
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.UserLevelGroupDayLimit(), middleware.Distribute())
	{
