...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		{
			userRoute.GET("/register_risk/challenge", middleware.CriticalRateLimit(), controller.CreateRegisterRiskChallenge)
			userRoute.POST("/register_risk/collect/:challenge_id", middleware.CriticalRateLimit(), controller.CollectRegisterRiskToken)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/stripe/pay", middleware.CriticalRateLimit(), controller.RequestStripePayCompat)
				selfRoute.POST("/stripe/amount", controller.RequestStripeAmount)
				selfRoute.POST("/creem/pay", middleware.CriticalRateLimit(), controller.RequestCreemPayCompat)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/consumption_rank", controller.AdminGetConsumptionRank)
				adminRoute.GET("/subscription_usage_rank", controller.AdminGetSubscriptionUsageRank)
				adminRoute.GET("/invite_rank", controller.AdminGetInviteRank)
				adminRoute.GET("/invite_reward_audits", controller.AdminGetInviteRewardAudits)
				adminRoute.GET("/:id/redemptions", controller.AdminGetUserRedemptionRecords)
				adminRoute.GET("/:id/subscription_sources", controller.AdminGetUserSubscriptionSourceRecords)
				adminRoute.GET("/:id/subscription_daily_stats", controller.AdminGetUserSubscriptionDailyStats)
		...
		{
			paymentRoute.GET("/topup/meta", controller.GetPaymentTopupMeta)
			paymentRoute.POST("/topup/checkout", middleware.CriticalRateLimit(), controller.CreatePaymentTopupCheckout)
			paymentRoute.GET("/subscription/meta", controller.GetPaymentSubscriptionMeta)
			paymentRoute.POST("/subscription/checkout", middleware.CriticalRateLimit(), controller.CreatePaymentSubscriptionCheckout)
		}
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.POST("/epay/pay", middleware.CriticalRateLimit(), controller.SubscriptionRequestEpayCompat)
			subscriptionRoute.POST("/stripe/pay", middleware.CriticalRateLimit(), controller.SubscriptionRequestStripePayCompat)
			subscriptionRoute.POST("/creem/pay", middleware.CriticalRateLimit(), controller.SubscriptionRequestCreemPayCompat)
		}
		...
		subscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			...
			subscriptionAdminRoute.GET("/active_users", controller.AdminListActiveUserSubscriptions)
			subscriptionAdminRoute.GET("/users/:id/subscriptions", controller.AdminListUserSubscriptions)
			subscriptionAdminRoute.POST("/users/:id/subscriptions", controller.AdminCreateUserSubscription)
			subscriptionAdminRoute.POST("/user_subscriptions/reset_used/bulk", controller.AdminResetActiveUserSubscriptionsUsed)
			subscriptionAdminRoute.POST("/user_subscriptions/:id/reset_used", controller.AdminResetUserSubscriptionUsed)
		...
		dataRoute.GET("/channel", middleware.AdminAuth(), controller.GetChannelConsumptionData)
