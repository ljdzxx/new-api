...
export function setStatusData(data) {
  ...
  localStorage.setItem(
    'payment_display_currency_type',
    data.payment_display_currency_type || 'FOLLOW_QUOTA',
  );
  localStorage.setItem(
    'payment_display_currency_symbol',
    data.payment_display_currency_symbol || '\u00A4',
  );
  localStorage.setItem(
    'payment_display_currency_exchange_rate',
    data.payment_display_currency_exchange_rate ?? 1,
  );
