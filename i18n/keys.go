...
const (
	...
	MsgDistributorImageModelRequiresImageEndpoint     = "distributor.image_model_requires_image_endpoint"
	MsgDistributorCompactModelRequiresCompactEndpoint = "distributor.compact_model_requires_compact_endpoint"
)
