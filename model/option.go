...
func InitOptionMap() {
	...
	common.OptionMap["DisableImageGenerationOnNonImageEndpoints"] = strconv.FormatBool(common.DisableImageGenerationOnNonImageEndpoints)
	...
	common.OptionMap["GroupRateLimit"] = setting.GroupRateLimit2JSONString()
	...
	common.OptionMap["GroupIcon"] = ratio_setting.GroupIcon2JSONString()
	common.OptionMap["GroupGroupRatio"] = ratio_setting.GroupGroupRatio2JSONString()
	common.OptionMap["UserUsableGroups"] = setting.UserUsableGroups2JSONString()
	common.OptionMap["UserLevelPolicies"] = setting.UserLevelPolicies2JSONString()
	common.OptionMap["CompletionRatio"] = ratio_setting.CompletionRatio2JSONString()
	common.OptionMap["ImageRatio"] = ratio_setting.ImageRatio2JSONString()
	common.OptionMap["AudioRatio"] = ratio_setting.AudioRatio2JSONString()
	common.OptionMap["AudioCompletionRatio"] = ratio_setting.AudioCompletionRatio2JSONString()
	common.OptionMap["PricingDisplayModels"] = ratio_setting.PricingDisplayModels2JSONString()
	...
	common.OptionMap["monitor_setting.global_quota_insufficient_keywords"] = operation_setting.GlobalQuotaInsufficientKeywordsToJSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "InviteRewardEmailOnly" || key == "DisableImageGenerationOnNonImageEndpoints" {
		...
		case "DisableImageGenerationOnNonImageEndpoints":
			common.DisableImageGenerationOnNonImageEndpoints = boolValue
		case "TaskEnabled":
	...
	case "GroupRateLimit":
		err = setting.UpdateGroupRateLimitByJSONString(value)
	case "RetryTimes":
	...
	case "ModelBillingPolicy":
		err = billing_policy.UpdateFromJSON(value)
	...
	case "GroupIcon":
		err = ratio_setting.UpdateGroupIconByJSONString(value)
	...
	case "PricingDisplayModels":
		err = ratio_setting.UpdatePricingDisplayModelsByJSONString(value)
	case "TopUpLink":
