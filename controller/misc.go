...
func publicEmailDomainWhitelist(domains []string) []string {
...
func GetStatus(c *gin.Context) {
	...
	data := gin.H{
		...
		"email_domain_whitelist":           publicEmailDomainWhitelist(common.EmailDomainWhitelist),
		...
		"payment_display_currency_type":          operation_setting.GetPaymentDisplayCurrencyType(),
		"payment_display_currency_symbol":        operation_setting.GetPaymentDisplayCurrencySymbol(),
		"payment_display_currency_exchange_rate": operation_setting.GetPaymentSetting().DisplayCurrencyExchangeRate,
...
func GetAvailability(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		"success": true,
		"message": "",
		"data":    common.OptionMap["Availability"],
	})
	return
}
